...
export default function CreateRule() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Criando regra:', formData);
    navigate('/rules');
  };
  ...
  return (
    <div className="space-y-fluap">
      <div className="flex items-center space-x-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Criar Regra</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="fluap-card space-y-6">
        <div>
          ...
          <input
            ...
            placeholder="Ex: Alerta de Vencimento de Medicamentos"
          />
        </div>
        ...
        {(formData.triggerType === 'condition' || formData.triggerType === 'ai') && (
          <div>
            ...
            <input
              ...
              className="fluap-input"
              placeholder={formData.triggerType === 'condition' ? 'Ex: validade < 30 dias' : 'Ex: IA detecta padrão anômalo'}
            />
            {formData.triggerType === 'condition' && (
              <p className="text-sm text-gray-500 mt-2">
                Use operadores: &lt;, &gt;, =, contains, etc.
              </p>
            )}
          </div>
        )}
